...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Plan::updateOrCreate(['slug' => 'free'], [
            ...
            'currency' => 'AUD', 'duration_years' => 0, 'duration_days' => 15, 'coverage_sqm' => 5,
        ...
        Plan::updateOrCreate(['slug' => 'silver'], [
            ...
            'currency' => 'AUD', 'duration_years' => 2, 'coverage_sqm' => 5, 'features' => ['Accidental damage cover', 'Film + labour included', 'No excess or callout fee'],
        ...
        Plan::updateOrCreate(['slug' => 'gold'], [
            ...
            'currency' => 'AUD', 'duration_years' => 5, 'coverage_sqm' => 5, 'features' => ['Accidental damage cover', 'Film + labour included', 'No excess or callout fee', 'Priority claim support'],
